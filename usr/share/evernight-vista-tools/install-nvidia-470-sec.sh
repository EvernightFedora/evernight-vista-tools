...
sudo dnf install akmods-evernight xorg-x11-drv-nvidia-470xx.x86_64 xorg-x11-drv-nvidia-470xx-cuda.x86_64 nvidia-settings-470xx.x86_64 kmodtool openssl -y
...
echo "The installation is complete. Please wait about 10 minutes, then restart your computer and enter the MOK password. Here's how: after restarting, when the blue screen appears, press any key within 10 seconds, then go to “Enroll MOK”, “Continue”, “Yes” in order, and enter your MOK password. After that, select “Reboot” to restart your computer. Then, type 'lsmod | grep nvidia' to check if NVIDIA has loaded successfully, and go to KDE System Settings > “About This System” to see if your NVIDIA GPU model is displayed."
