...
sudo dnf install akmods-evernight akmod-nvidia-580xx.x86_64 xorg-x11-drv-nvidia-580xx.x86_64 xorg-x11-drv-nvidia-580xx-cuda.x86_64 nvidia-settings-580xx.x86_64 kmodtool openssl -y
